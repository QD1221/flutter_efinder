...
class CategoryDetailScreen extends StatefulWidget {
  ...
  const CategoryDetailScreen({Key key, this.categoryModel}) : super(key: key);
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Expanded(
                                                ...
                                                child: Container(
                                                  child: Text(
                                                    "\$${productProvider.productsByCategory[index].price}",
                                                    style: TextStyle(
                                                        fontSize: 14,
                  ...
                  child: Card(
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          top: ResponsiveWidget.isMediumScreen(context) ? 10 : 15,
                          right: ResponsiveWidget.isMediumScreen(context) ? 10 : 15,
                          child: Container(
                            width: 70,
                            height: 30,
                            decoration: BoxDecoration(
                            ...
                            child: Align(
                              ...
                              child: CustomText(
                                text: '65 tuần',
                                color: white,
                                size: ResponsiveWidget.isMediumScreen(context) ? 14 : 16,
                                weight: FontWeight.w300,
                              ),
                            ),
                          ),
                  ...
                  tabs: [
                    ...
                    Tab(
                      child: Align(
                          alignment: Alignment.center,
                          child:
                              Text('Hình ảnh', style: TextStyle(fontSize: 16))),
                    ),
                  ],
